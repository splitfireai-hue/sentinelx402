...
CMD python -m app.data.seed_threats || echo "Seed skipped (data may already exist)" ; python -m gunicorn app.main:app --worker-class uvicorn.workers.UvicornWorker --bind 0.0.0.0:$PORT --workers 1 --timeout 60 --access-logfile - --error-logfile -
